 ...
 * Returns music recommendations based on mood
 * Requires LASTFM_API_KEY and optionally YOUTUBE_API_KEY
 */
router.get('/', musicLimiter, async (req, res) => {
  try {
    ...
    if (!lastfmApiKey || lastfmApiKey === 'your_lastfm_api_key_here') {
      return res.status(500).json({ 
        ...
        message: 'LASTFM_API_KEY is required. Please configure it in your .env file.' 
      });
    }
